...
// Отбор только существующих языков.
...
// Массивы поддерживают метод reduce. Если размер массива больше 1, то
// начальным значением считается 1-й элемент.
console.log([1, 2, 3].reduce((a, b) => a + b));

// Нахождение письменности с самым большим количеством букв.
